...
public:
  ...
  static joint_positions_solution_t solve_preferred_pitch_ik(double preferred_pitch,
                                                             geometry_msgs::Point desired_position,
                                                             geometry_msgs::Vector3 desired_normal);

  static joint_positions_solution_t solve_preferred_type_ik(bool arm_to_front, bool arm_bended_up,
                                                            bool gripper_downwards,
                                                            geometry_msgs::Point desired_position,
                                                            geometry_msgs::Vector3 desired_normal);

  static joint_positions_solution_t solve_fully_constrained_ik(int id, double pitch,
                                                               geometry_msgs::Point desired_position,
                                                               geometry_msgs::Vector3 desired_normal);
...
private:
  ...
  static void calculate_unique_pitch_solutions(std::vector<joint_positions_solution_t>& solutions,
                                               geometry_msgs::Point desired_position,
                                               geometry_msgs::Vector3 desired_normal);

  static void calculate_degenerative_solutions(std::vector<joint_positions_solution_t>& solutions,
                                               geometry_msgs::Point desired_position);
  static bool exists_unique_pitch_solution(geometry_msgs::Point desired_position,
                                           geometry_msgs::Vector3 desired_normal);
  ...
  static joint_positions_solution_t compute_exact_pitch_solution(double preferred_pitch,
                                                                 geometry_msgs::Point desired_position,
                                                                 geometry_msgs::Vector3 desired_normal);
  static joint_positions_solution_t take_closest_pitch_solution(double preferred_pitch,
                                                                std::vector<joint_positions_solution_t> solutions);
  ...
  static joint_positions_solution_t take_closest_type_solution(bool arm_to_front, bool arm_bended_up,
                                                               bool gripper_downwards,
                                                               std::vector<joint_positions_solution_t> solutions);
  ...
  static joint_positions_solution_t compute_single_ik_solution(Eigen::Vector3d des_position, double des_roll,
