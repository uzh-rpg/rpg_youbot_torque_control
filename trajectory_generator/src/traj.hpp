...
public:
  ...
  TrajectoryGenerator* getTrajectory(Eigen::VectorXd & s_pos, Eigen::VectorXd & e_pos,
                                                       Eigen::VectorXd & s_vel, Eigen::VectorXd & e_vel);
  TrajectoryGenerator* getTrajectory(Eigen::Affine3d & s_pos, Eigen::Affine3d & e_pos, double s_vel,
                                                       double e_vel);
...
private:
  int generateEndPosition(const Eigen::VectorXd& q_in, const Eigen::VectorXd& p_in, const Eigen::VectorXd& startvel, const Eigen::VectorXd& endvel);
